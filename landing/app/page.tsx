      ...
      <div className="space-y-6 text-center max-w-4xl px-4">
        ...
        >
          <div className="flex items-center gap-2 text-sm font-medium text-blue-900 dark:text-blue-200">
            ...
            <span>The Ultimate Impact Measurement Platform</span>
          </div>
        </motion.div>
        ...
        >
          Simplifying Sustainability Reporting.<br className="hidden sm:block" />
        ...
        >
          frontforumfocus is an AI-driven platform that automates
           sustainability data collection and provides real-time analytics for organizations and individuals.
        </motion.p>
